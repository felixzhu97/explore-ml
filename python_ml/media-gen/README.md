...
Single service for image generation (Stable Diffusion), video generation (CogVideoX), and voice synthesis (edge-tts). Port: 8003.
...
Server: set `MEDIA_GENERATION_API_URL=http://localhost:8003` in application.yml `chat.upstreams.media-gen`.
